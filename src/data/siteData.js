export const site = {
  "dir": "deckbuilderfrederick",
  "domain": "deckbuilderfrederick.com",
  "title": "Deck Builder Frederick",
  "business": "Deck Builder Frederick",
  "phone": "(240) 555-0138",
  ...
  "imageIndex": 0,
  "noun": "deck project",
  "plural": "deck projects",
  "proof": [
    "Custom deck design",
    "Composite and pressure-treated builds",
  ...
  "families": [
    {
      ...
      "shortDescription": "Custom Deck Building for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific custom deck building planning",
    ...
    },
    {
      ...
      "shortDescription": "Deck Repair & Resurfacing for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific deck repair & resurfacing planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
    ...
    {
      "slug": "railings-stairs-features",
      "name": "Railings, Stairs & Features",
      "shortDescription": "Railings, Stairs & Features for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific railings, stairs & features planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
    ...
    {
      "slug": "outdoor-living-upgrades",
      "name": "Outdoor Living Upgrades",
      "shortDescription": "Outdoor Living Upgrades for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific outdoor living upgrades planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
    ...
    {
      "slug": "property-specific-decks",
      "name": "Property-Specific Decks",
      "shortDescription": "Property-Specific Decks for Frederick properties with clear planning, careful workmanship, and local service context.",
      "keyPoints": [
        "Frederick-specific property-specific decks planning",
        "Clear estimates and staged scheduling",
        "Clean, documented completion standards"
      ],
      "overview": [
